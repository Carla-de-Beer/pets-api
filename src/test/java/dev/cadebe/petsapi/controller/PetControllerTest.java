...
import dev.cadebe.petsapi.controller.v1.PetController;
import dev.cadebe.petsapi.exception.ResourceNotFoundException;
import dev.cadebe.petsapi.exception.RestResponseEntityExceptionHandler;
...
class PetControllerTest {
    ...
    void createNewPet() throws Exception {
        ...
        mockMvc.perform(post(getPetsURL())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(AbstractRestControllerTest.asJsonString(petDTO)))
